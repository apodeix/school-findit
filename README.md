...
- 교사·최종 관리자의 실제 습득물 인수 대기 조회와 인수 공개
- 최종 관리자의 교사 인증코드 설정과 학생 계정의 1회 교사 인증
- 실제 인수 알림, 읽지 않음 배지와 최종 관리자의 잘못된 알림 취소
- 날짜 및 입력칸별 오류 안내, 내가 쓴 글 필터와 로그아웃
- 본인의 진행 중 글 수정과 삭제 기록을 남기는 소프트 삭제
- 최종 관리자 인증코드 설정 및 일반 교사 인증
- 교사 인수 알림의 영구 저장·읽음 처리·관리자 취소 기록
- 내가 쓴 글 필터와 명확한 등록 입력 오류 안내
